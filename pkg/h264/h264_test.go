...
func TestDecodeSPS(t *testing.T) {
	...
	sps := DecodeSPS(b)
	assert.Equal(t, uint16(2560), sps.Width())
	assert.Equal(t, uint16(1920), sps.Height())
	...
	sps = DecodeSPS(b)
	assert.Equal(t, uint16(1920), sps.Width())
	assert.Equal(t, uint16(1080), sps.Height())
	...
	sps = DecodeSPS(b)
	assert.Equal(t, uint16(1280), sps.Width())
	assert.Equal(t, uint16(720), sps.Height())
	...
	sps = DecodeSPS(b)
	assert.Equal(t, uint16(640), sps.Width())
	assert.Equal(t, uint16(360), sps.Height())
}
